...
//		gridJPanel.getjPanels()[0].add(new FigureContain(ReadInfo.readFigureInfo(3, 4)));
//
//		JPanelShow.bodyJPanelShow(gridJPanel, 4);
		...
		JLabel jLabel = new JLabel("极值有效桥板温度", JLabel.CENTER);
		...
		JPanelShow.bodyJPanelShow(panel, 4);
