 ...
 * @Date 2019年5月27日
 */
public class ComplexBodyUI extends BasicTableUI
{
	private final Object[][] headerRows;
	private final JTable table;
	private final int singleRowHeight;

	public ComplexBodyUI(Object[][] headerRows, JTable table)
	{
	...
	public void paint(Graphics g, JComponent c)
	{
		for (int row = 0; row < headerRows.length; row++)
		{
			...
			for (int col = 0; col < headerRow.length; col++)
			{
				...
				if (cell == ComplexTable.mergeCellX ||
						cell == ComplexTable.mergeCellY ||
						(col > 0 && row > 0 && headerRow[col - 1] == ComplexTable.mergeCellY
